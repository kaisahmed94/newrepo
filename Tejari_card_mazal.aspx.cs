...
namespace ReportsProject
{
    ...
    public partial class Tejari_card_mazal : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["NCBVouchersManagementSystemConnectionString"].ConnectionString);
            try
            {
