...
{
    public partial class NCB_Count_SucssesDW : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Wcharge_NCB_count", con);
                ...
                cmd.Parameters.AddWithValue("@pr", DropDownList2.SelectedValue);
