...
{
    public partial class NCB_Count_FaildBP : System.Web.UI.Page
    {
        string x;
        int i;
        private DataSet GetDataresult()
        {
            ...
            try
            {
              //  x = DropDownList3.SelectedItem.Text;
                ...
                SqlCommand cmd = new SqlCommand("ka_PB_faield_branch", con);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    SqlCommand com = new SqlCommand(" select *   FROM [NCBMittSystemCoreDBLogs].[dbo].[BANK_REPLAY] where REPLAY <> '999'", con); // table name 
