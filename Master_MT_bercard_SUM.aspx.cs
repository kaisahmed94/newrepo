...
{
    public partial class Master_MT_bercard_SUM : System.Web.UI.Page
    {
        int x;
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Master_MT_bercard_SUM", con);
        ...
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Master_MT_bercard_Transactions", con);
                cmd.CommandType = CommandType.StoredProcedure;
