...
{
    public partial class MT_Faield : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_MTranfer_faield_NCB", con);
        ...
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_MTranfer_faield_NCB_count", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DropDownList3_SelectedIndexChanged(EventArgs e)
        {
