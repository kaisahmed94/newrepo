<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="KA_ES_Count_W.aspx.cs" Inherits="ReportsProject.KA_ES_Count_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

                                        <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">اجمالي العمليات الناجحة والفاشلة لكشف الحساب علي الايميل</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
