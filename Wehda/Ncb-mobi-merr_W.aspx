<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="Ncb-mobi-merr_W.aspx.cs" Inherits="ReportsProject.Ncb_mobi_merr_W" %>
       ...
       <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير صافي المبيعات لتجار خلال فنرة معينة  </h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
