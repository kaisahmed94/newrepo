<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="Custs_per_class_W.aspx.cs" Inherits="ReportsProject.Custs_per_class_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                         <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">عدد المشتركين تحت كل تصنيف</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                              <%--  <div class="row">
