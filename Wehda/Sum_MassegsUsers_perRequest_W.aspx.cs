...
{
    public partial class Sum_MassegsUsers_perRequest_W : System.Web.UI.Page
    {
        private DataSet GetDataresult()
        {

            DataSet resultstable = new DataSet();
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["sms_90ConnectionString"].ConnectionString);
            try
            {
