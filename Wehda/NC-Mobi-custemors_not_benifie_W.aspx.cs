...
{
    public partial class NC_Mobi_custemors_not_benifie_W : System.Web.UI.Page
    {
        int i;
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Ka_custemors_haveManytransaction_but_not_benifie", con);
