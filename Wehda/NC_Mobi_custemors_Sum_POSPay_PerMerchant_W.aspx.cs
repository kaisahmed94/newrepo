...
{
    public partial class NC_Mobi_custemors_Sum_POSPay_PerMerchant_W : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Ka_Sum_POSPay_PerMerchant", con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@x", TextBox1.Text);
                cmd.Parameters.AddWithValue("@Datefrom", TextBox3.Text);
