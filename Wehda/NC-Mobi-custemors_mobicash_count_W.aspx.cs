...
{
    public partial class custemors_mobicash_count_W : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_custemors_mobicash_count", con);
        ...
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_custemors_mobicash", con);
                cmd.CommandType = CommandType.StoredProcedure;
