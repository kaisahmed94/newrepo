...
{
    public partial class NCB_LIMET_mobimalpay_Merchants_W : System.Web.UI.Page
    {
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("ka_Mer_payment", con);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                string constr = ConfigurationManager.ConnectionStrings["wahdaSCIConnectionStr"].ToString(); // connection string
