<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC_Mobi_custemors_Sum_Pay_PerMerchant_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_custemors_Sum_Pay_PerMerchant_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير عن اجمالي العمليات   لكل تاجر  </h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                                <div class="row">
