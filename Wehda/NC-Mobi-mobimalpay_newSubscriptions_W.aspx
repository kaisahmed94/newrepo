<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-mobimalpay_newSubscriptions_W.aspx.cs" Inherits="ReportsProject.mobimalpay_newSubscriptions_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                 <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">عدد التجار لكل فرع حسب التاريخ</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                                <div class="row">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" 
                                                    AllowPaging="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" >
                                                </asp:GridView>
