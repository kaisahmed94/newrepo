<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NCB-Counts-AutoSms_W.aspx.cs" Inherits="ReportsProject.NCB_Counts_AutoSms_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                        <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">اجمالي الرسائل التلقائية</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
  ...
  <br />
            ...
            <br />
                                                        ...
                                                        <div class="row">
                    <div class="col-md-12" style="    padding-top: 24px;">
                         <asp:Button ID="Button2" runat="server" class="btn btn-primary btn-wd  pull-right" OnClick="Button2_Click" Text="طباعة" Visible="false" />
