...
{
    public partial class Custemors_active_FinacialTran_perBranch_W : System.Web.UI.Page
    {
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Custemors_active_FinacialTran_perBranch", con);
