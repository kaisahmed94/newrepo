...
namespace ReportsProject
{
    ...
    public partial class Tejari_card_mazal_W : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["wahdaVouchersManagementSystemConnectionString"].ConnectionString);
            try
            {

                SqlCommand cmd = new SqlCommand("KA_tej_MAZ", con);
