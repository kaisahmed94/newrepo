<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC_Mobi_num_Merchants_Pos_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_num_Merchants_Pos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                     <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">اجمالي  عدد نقاط البيع للتجار</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
