<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-custemors_Pay_SumPayment_perDate_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_custemors_Pay_SumPayment_perDate_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير اجمالي المبيعات لتاريخ معين </h4>
                                        </div>
                                        <div class="card-body" >
                                            <div class="container">
                                                <div class="row">
