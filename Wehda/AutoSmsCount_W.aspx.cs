...
{
    public partial class AutoSmsCount_W : System.Web.UI.Page
    {
        private DataSet GetDataresult()
        {

            DataSet resultstable = new DataSet();
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["sms_archiveConnectionString"].ConnectionString);
            try
            {
