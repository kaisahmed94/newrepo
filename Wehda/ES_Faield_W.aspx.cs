...
namespace ReportsProject
{
    ...
    public partial class ES_Faield_W : System.Web.UI.Page
    {
        string i;
        int x;
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Emaiel_Faield_NCB", con);
        ...
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Emaiel_Faield_NCBcount", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                string constr = ConfigurationManager.ConnectionStrings["logs95_W"].ToString(); // connection string
