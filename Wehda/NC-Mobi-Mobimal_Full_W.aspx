<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-Mobimal_Full_W.aspx.cs" Inherits="ReportsProject.WebForm3_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
             <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير مبيعات خدمة الدفع الالكتروني حسب المنطقة الجغرافية
                                            </h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <asp:ListItem Value="2">الشرقية</asp:ListItem>
                                                    <asp:ListItem Value="3">الجبل الأخضر</asp:ListItem>
                                                                                                           <asp:ListItem Value="4">الجبل الغربي</asp:ListItem>

                                                            <asp:ListItem Value="4">السدرة</asp:ListItem>
                                                            <asp:ListItem Value="5">الوسطى</asp:ListItem>
                                                ...
                                                <br />
                                                <br />
                                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" PagerStyle-HorizontalAlign="Left" PagerSettings-Position="Bottom" PagerSettings-Mode="Numeric"
                    GridLines="None" AutoGenerateColumns="true" AllowPaging="true"  OnPageIndexChanging="GridView1_PageIndexChanging" >
                                                </asp:GridView>
