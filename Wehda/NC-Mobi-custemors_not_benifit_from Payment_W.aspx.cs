...
{
    public partial class NC_Mobi_custemors_not_benifit_from_Payment_W : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Ka_Custemors_not_benifit_from Payment", con);
