<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="MT_Success_W.aspx.cs" Inherits="ReportsProject.MT_Success_W" %>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" style="padding-top: 24px;">
                             ...
                             <div class="col-md-12" style="padding-top: 24px;">
                                <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-wd  pull-right" OnClick="Button1_Click" Visible="false" Text="التفاصيل" />
