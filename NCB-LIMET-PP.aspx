<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="NCB-LIMET-PP.aspx.cs" Inherits="ReportsProject.NCB_LIMET_PP" %>
                        ...
                        <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">الأسقف الخاصة بدفع الفواتير</h4>
                                        </div>
                                        <div class="card-body ">
      <%--                                             <div class="row">
