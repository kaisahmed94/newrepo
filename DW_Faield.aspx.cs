...
{
    public partial class DW_Faield : System.Web.UI.Page
    {
        int x;
        string i;
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("ka_Wchar_Faield", con);
        ...
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("ka_Wchar_Faield_count", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.AddWithValue("@i", i);
                cmd.Parameters.AddWithValue("@d", DropDownList2.SelectedValue);
                cmd.Parameters.AddWithValue("@pid", DropDownList3.SelectedValue);
