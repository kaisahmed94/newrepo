...
{
    public partial class PP_Succees : System.Web.UI.Page
    ...
    //        SqlCommand cmd = new SqlCommand("KA_BPill_NCB_Count", con);
    ...
    //            cmd.Parameters.AddWithValue("@pid", DropDownList4.SelectedValue);
    ...
    //}
        private DataSet GetDataresult1()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_BPill_NCB", con);
                cmd.CommandType = CommandType.StoredProcedure;
