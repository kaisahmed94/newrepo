<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="BV_sucsees.aspx.cs" Inherits="ReportsProject.BV_sucsees" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <asp:DropDownList ID="DropDownList2" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server">
     ...
     <asp:ListItem Value="2">تفاصيلي</asp:ListItem>
                                                                                                                 ...
                                                                                                                 <div class="row">
           <label class="col-sm-2 col-form-label">أختر نوع الاشتراك</label>
                                                         </div>
                                                <div class="row">
          <div class="col-sm-7">
            ...
            <div class="col-sm-7">
                ...
                <div class="row">
                    <%--<div class="col-md-12" style="    padding-top: 24px;">
                         ...
                         <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-wd  pull-right" OnClick="Button1_Click" Text="ادخال" Visible="true" />
                    </div>
