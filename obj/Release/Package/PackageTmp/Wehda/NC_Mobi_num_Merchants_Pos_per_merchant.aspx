<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="NC_Mobi_num_Merchants_Pos_per_merchant.aspx.cs" Inherits="ReportsProject.NC_Mobi_num_Merchants_Pos_per_merchant_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                         <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">اجمالي  عدد نقاط البيع لتاجر معين</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <asp:TextBox ID="TextBox1" runat="server" class="form-control datepicker" placeholder="MerchentID" Height="30px" type="text"></asp:TextBox>
                                                </div>
