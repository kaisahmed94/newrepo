<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="ES_Success_W.aspx.cs" Inherits="ReportsProject.ES_Success_W" %>
    ...
    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">العمليات الناجحة لكشف الحساب عن طريق الايميل</h4>
                                        </div>
                                        <div class="card-body " >
                                                   <div class="row" >
...
<asp:DropDownList ID="DropDownList3" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
    ...
    <asp:ListItem Value="200">أعمال</asp:ListItem>
        ...
        <div class="row">
            <div class="col-sm-7">
                <asp:DropDownList ID="DropDownList1" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging">
                                                        </asp:DropDownList>
            </div>
            <div class="col-sm-7">
