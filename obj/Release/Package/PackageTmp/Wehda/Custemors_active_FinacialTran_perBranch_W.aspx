<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="Custemors_active_FinacialTran_perBranch_W.aspx.cs" Inherits="ReportsProject.Custemors_active_FinacialTran_perBranch_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                                                    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير مفعلين الخدمات المالية لكل فرع</h4>
                                            <div class="row">
                                                <br />
                                            </div>
                                            <div class="row">
