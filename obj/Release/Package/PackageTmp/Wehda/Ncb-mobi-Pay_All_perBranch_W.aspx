<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="Ncb-mobi-Pay_All_perBranch_W.aspx.cs" Inherits="ReportsProject.Wehda.Ncb_mobi_Pay_All_perBranch_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">تقرير صافي المبيعات والعمليات لكل تاجر </h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
