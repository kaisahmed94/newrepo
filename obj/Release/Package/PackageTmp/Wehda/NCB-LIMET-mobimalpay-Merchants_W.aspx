<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NCB-LIMET-mobimalpay-Merchants_W.aspx.cs" Inherits="ReportsProject.NCB_LIMET_mobimalpay_Merchants_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

                            <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">الأسقف الخاصة بتجار خدمة الدفع الالكتروني</h4>
                                        </div>
                                        <div class="card-body ">
      <%--                                             <div class="row">
