<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-custemors_not_benifit_from Payment_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_custemors_not_benifit_from_Payment_W" %>
...
<%--                                                <div class="row">
                                                ...
                                                <br />
                                                <br />
                                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" AllowPaging="true" AutoGenerateColumns="true" OnPageIndexChanging="GridView1_PageIndexChanging" >
                                                </asp:GridView>
