<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-custemors_Sum_Pay_ChargeBack_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_custemors_Sum_Pay_ChargeBack" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">اجمالي  اجمالي  عمليات  الدفع و الاسترجاع</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                               <%-- <div class="row">
