<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="Cus_Stoped_bybank_W.aspx.cs" Inherits="ReportsProject.Cus_Stoped_bybank_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                     <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">المشتركين الغير مفعلين من المصرف</h4>
                                        </div>
                                        <div class="card-body ">
                                            <div class="container">
                                          <%--   <div class="row">
...
<%--                                                <div class="row">
                                                ...
                                                <br />
                                                <br />
                                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" AllowCustomPaging="false"  OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true">
                                                </asp:GridView>
                                                <br />
                                            <div class="col-md-12" style="padding-top: 24px;">
