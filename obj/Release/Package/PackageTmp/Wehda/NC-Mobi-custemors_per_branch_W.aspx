<%@ Page Title="" Language="C#" MasterPageFile="~/Wehda/WahdaMaster.Master" AutoEventWireup="true" CodeBehind="NC-Mobi-custemors_per_branch_W.aspx.cs" Inherits="ReportsProject.NC_Mobi_custemors_per_branch_W" %>
                                        ...
                                        <div class="card-body ">
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <asp:ListItem Value="1">الشرقية</asp:ListItem>
                                                    <asp:ListItem Value="2">طرابلس</asp:ListItem>
                                                    <asp:ListItem Value="3">الجبل الأخضر</asp:ListItem>
                                                    <asp:ListItem Value="4">الجبل الغربي</asp:ListItem>
                                                                                                           <asp:ListItem Value="4">الجبل الغربي</asp:ListItem>

                                                            <asp:ListItem Value="5">السدرة</asp:ListItem>
                                                            <asp:ListItem Value="6">الوسطى</asp:ListItem>
                                                ...
                                                <br />
                                                <br />
                                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" AllowPaging="true"  OnPageIndexChanging="GridView1_PageIndexChanging"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                                                </asp:GridView>
