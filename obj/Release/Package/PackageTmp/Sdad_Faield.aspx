<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="Sdad_Faield.aspx.cs" Inherits="ReportsProject.Sdad_Faield" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">العمليات التي تم رفضها من مزود الخدمة ( سداد )</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
