<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="DW_Faield.aspx.cs" Inherits="ReportsProject.DW_Faield" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
            <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">العمليات الفاشلة لشحن المحافظ</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
...
<asp:DropDownList ID="DropDownList2" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
    ...
    <asp:ListItem></asp:ListItem>
              ...
              <div class="row">
            <label class="col-sm-2 col-form-label">اشاري الفرع</label>
