<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="master_ChangeState.aspx.cs" Inherits="ReportsProject.master_ChangeState" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">عمليات تغيير الحالات للبطاقات الدولية</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
...
<asp:DropDownList ID="DropDownList1" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
    <asp:ListItem Value="1">تفعيل</asp:ListItem>
    <asp:ListItem Value="31">الغاء تفعيل</asp:ListItem>
...
<%--        <div class="row">--%>
  ...
  <br />
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" class="table table-hover table-striped" AllowPaging="true" AllowCustomPaging="false" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging">
            </asp:GridView>
