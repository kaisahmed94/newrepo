<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="Tdawel_faield.aspx.cs" Inherits="ReportsProject.Tdawel_faield" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                    <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">العمليات التي تم رفضها من مزود الخدمة ( تداول )</h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
