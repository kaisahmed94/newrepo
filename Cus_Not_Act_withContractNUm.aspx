<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="Cus_Not_Act_withContractNUm.aspx.cs" Inherits="ReportsProject.Cus_Not_Act_withContractNUm" %>
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <asp:DropDownList ID="DropDownList1" class="btn-group bootstrap-select show-tick" data-toggle="dropdown" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
                            ...
                            <asp:ListItem Value="2">تفصيلي</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    </div>
                    <%--        <div class="row">
                        ...
                        <%--    <div class="col-md-12" style="padding-top: 24px;">
                                                            <asp:TextBox ID="TextBox1" runat="server" class="form-control datepicker" Height="30px" type="Text" Visible="false">أدخل رقم الهاتف</asp:TextBox>
