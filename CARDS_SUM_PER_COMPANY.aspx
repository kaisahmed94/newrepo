<%@ Page Title="" Language="C#" MasterPageFile="~/NCBMAS.Master" AutoEventWireup="true" CodeBehind="CARDS_SUM_PER_COMPANY.aspx.cs" Inherits="ReportsProject.CARDS_SUM_PER_COMPANY" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                                            <form id="RangeValidation"  class="form-horizontal" action="" method="" novalidate="novalidate" runat="server">
                                    <div class="card " style="direction:rtl">
                                        <div class="card-header ">
                                            <h4 class="card-title">إجمالي مبيعات الكروت حسب الفئة والشركة </h4>
                                        </div>
                                        <div class="card-body ">
                                                   <div class="row">
