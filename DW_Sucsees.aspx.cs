...
{
    public partial class DW_Sucsees : System.Web.UI.Page
    {
        ...
        private DataSet GetDataresult()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("KA_Wcharge_NCB", con);
                ...
                cmd.Parameters.AddWithValue("@i", DropDownList2.SelectedValue);
